...
namespace generator
{
    ...
    {
        public FrequencyGenerator(String filePath)
        {
        ...
        public FrequencyGenerator(Dictionary<String, int> usageTable)
        {
    ...
    class BigramGenerator
    {
        ...
        public BigramGenerator(Dictionary<char,Dictionary<char,int>> usageTable)
        {
            usageBase = usageTable;
    ...
    class Program
    {
        ...
        {
            BigramGenerator bgen = new BigramGenerator(@"..\..\..\BigramBase.txt");
            FrequencyGenerator fgen1 = new FrequencyGenerator(@"..\..\..\FrequencyBaseSingle.txt");
            FrequencyGenerator fgen2 = new FrequencyGenerator(@"..\..\..\FrequencyBaseDouble.txt");
            File.WriteAllText(@"..\..\..\BigramOutput.txt",bgen.Next(1000));
            File.WriteAllText(@"..\..\..\FrequencySingleOutput.txt", fgen1.Next(1000));
            File.WriteAllText(@"..\..\..\FrequencyDoubleOutput.txt", fgen2.Next(1000));
        }
    }
}
